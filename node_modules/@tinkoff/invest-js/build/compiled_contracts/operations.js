...
exports.OperationsRequest = {
    ...
    create(base) {
        return exports.OperationsRequest.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b, _c, _d, _e;
        const message = createBaseOperationsRequest();
        ...
        message.state = (_d = object.state) !== null && _d !== void 0 ? _d : undefined;
        message.figi = (_e = object.figi) !== null && _e !== void 0 ? _e : undefined;
        return message;
    },
};
...
exports.OperationsResponse = {
    ...
    create(base) {
        return exports.OperationsResponse.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a;
        const message = createBaseOperationsResponse();
...
exports.Operation = {
    encode(message, writer = new wire_1.BinaryWriter()) {
        ...
        for (const v of message.childOperations) {
            exports.ChildOperationItem.encode(v, writer.uint32(154).fork()).join();
        }
        return writer;
    },
    decode(input, length) {
    ...
    fromJSON(object) {
        return {
            ...
            trades: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.trades) ? object.trades.map((e) => exports.OperationTrade.fromJSON(e)) : [],
            ...
            childOperations: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.childOperations)
    ...
    toJSON(message) {
        ...
        if ((_b = message.childOperations) === null || _b === void 0 ? void 0 : _b.length) {
    ...
    fromPartial(object) {
        ...
        message.assetUid = (_o = object.assetUid) !== null && _o !== void 0 ? _o : "";
        message.positionUid = (_p = object.positionUid) !== null && _p !== void 0 ? _p : "";
        message.instrumentUid = (_q = object.instrumentUid) !== null && _q !== void 0 ? _q : "";
        message.childOperations = ((_r = object.childOperations) === null || _r === void 0 ? void 0 : _r.map((e) => exports.ChildOperationItem.fromPartial(e))) || [];
        return message;
    },
};
...
exports.OperationTrade = {
    ...
    create(base) {
        return exports.OperationTrade.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b, _c;
        const message = createBaseOperationTrade();
...
exports.PortfolioRequest = {
    ...
    fromPartial(object) {
        ...
        const message = createBasePortfolioRequest();
        message.accountId = (_a = object.accountId) !== null && _a !== void 0 ? _a : "";
        message.currency = (_b = object.currency) !== null && _b !== void 0 ? _b : undefined;
        return message;
    },
};
...
exports.PortfolioResponse = {
    encode(message, writer = new wire_1.BinaryWriter()) {
        ...
        if (message.dailyYield !== undefined) {
            common_1.MoneyValue.encode(message.dailyYield, writer.uint32(122).fork()).join();
        }
        if (message.dailyYieldRelative !== undefined) {
            common_1.Quotation.encode(message.dailyYieldRelative, writer.uint32(130).fork()).join();
        }
        return writer;
    },
    decode(input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 15: {
                    ...
                    message.dailyYield = common_1.MoneyValue.decode(reader, reader.uint32());
                    continue;
                }
                case 16: {
                    if (tag !== 130) {
                    ...
                    message.dailyYieldRelative = common_1.Quotation.decode(reader, reader.uint32());
                    continue;
                }
            }
            if ((tag & 7) === 4 || tag === 0) {
    ...
    fromJSON(object) {
        return {
            ...
            totalAmountPortfolio: isSet(object.totalAmountPortfolio)
                ...
                : undefined,
            virtualPositions: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.virtualPositions)
                ? object.virtualPositions.map((e) => exports.VirtualPortfolioPosition.fromJSON(e))
                : [],
            dailyYield: isSet(object.dailyYield) ? common_1.MoneyValue.fromJSON(object.dailyYield) : undefined,
            dailyYieldRelative: isSet(object.dailyYieldRelative) ? common_1.Quotation.fromJSON(object.dailyYieldRelative) : undefined,
        };
    },
    toJSON(message) {
        var _a, _b;
        ...
        if ((_b = message.virtualPositions) === null || _b === void 0 ? void 0 : _b.length) {
            obj.virtualPositions = message.virtualPositions.map((e) => exports.VirtualPortfolioPosition.toJSON(e));
        }
        if (message.dailyYield !== undefined) {
            obj.dailyYield = common_1.MoneyValue.toJSON(message.dailyYield);
        }
        if (message.dailyYieldRelative !== undefined) {
            obj.dailyYieldRelative = common_1.Quotation.toJSON(message.dailyYieldRelative);
        }
        return obj;
    },
    create(base) {
    ...
    fromPartial(object) {
        ...
        message.totalAmountPortfolio = (object.totalAmountPortfolio !== undefined && object.totalAmountPortfolio !== null)
            ...
            : undefined;
        message.virtualPositions = ((_c = object.virtualPositions) === null || _c === void 0 ? void 0 : _c.map((e) => exports.VirtualPortfolioPosition.fromPartial(e))) || [];
        message.dailyYield = (object.dailyYield !== undefined && object.dailyYield !== null)
            ? common_1.MoneyValue.fromPartial(object.dailyYield)
            : undefined;
        message.dailyYieldRelative = (object.dailyYieldRelative !== undefined && object.dailyYieldRelative !== null)
            ? common_1.Quotation.fromPartial(object.dailyYieldRelative)
            : undefined;
        return message;
    },
};
...
exports.PositionsResponse = {
    ...
    fromJSON(object) {
        return {
            money: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.money) ? object.money.map((e) => common_1.MoneyValue.fromJSON(e)) : [],
            blocked: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.blocked) ? object.blocked.map((e) => common_1.MoneyValue.fromJSON(e)) : [],
            securities: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.securities)
            ...
            limitsLoadingInProgress: isSet(object.limitsLoadingInProgress)
                ...
                : false,
            futures: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.futures)
    ...
    toJSON(message) {
        var _a, _b, _c, _d, _e;
        const obj = {};
        if ((_a = message.money) === null || _a === void 0 ? void 0 : _a.length) {
            obj.money = message.money.map((e) => common_1.MoneyValue.toJSON(e));
        }
        if ((_b = message.blocked) === null || _b === void 0 ? void 0 : _b.length) {
            obj.blocked = message.blocked.map((e) => common_1.MoneyValue.toJSON(e));
        }
        if ((_c = message.securities) === null || _c === void 0 ? void 0 : _c.length) {
        ...
        if ((_d = message.futures) === null || _d === void 0 ? void 0 : _d.length) {
            obj.futures = message.futures.map((e) => exports.PositionsFutures.toJSON(e));
        }
        if ((_e = message.options) === null || _e === void 0 ? void 0 : _e.length) {
    ...
    fromPartial(object) {
        ...
        message.options = ((_f = object.options) === null || _f === void 0 ? void 0 : _f.map((e) => exports.PositionsOptions.fromPartial(e))) || [];
        message.accountId = (_g = object.accountId) !== null && _g !== void 0 ? _g : "";
        return message;
    },
};
...
exports.WithdrawLimitsRequest = {
    ...
    create(base) {
        return exports.WithdrawLimitsRequest.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a;
        const message = createBaseWithdrawLimitsRequest();
...
exports.WithdrawLimitsResponse = {
    ...
    fromJSON(object) {
        return {
            money: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.money) ? object.money.map((e) => common_1.MoneyValue.fromJSON(e)) : [],
            blocked: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.blocked) ? object.blocked.map((e) => common_1.MoneyValue.fromJSON(e)) : [],
            blockedGuarantee: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.blockedGuarantee)
    ...
    toJSON(message) {
        ...
        if ((_c = message.blockedGuarantee) === null || _c === void 0 ? void 0 : _c.length) {
            obj.blockedGuarantee = message.blockedGuarantee.map((e) => common_1.MoneyValue.toJSON(e));
        }
        return obj;
    },
    create(base) {
        return exports.WithdrawLimitsResponse.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b, _c;
        const message = createBaseWithdrawLimitsResponse();
...
exports.PortfolioPosition = {
    encode(message, writer = new wire_1.BinaryWriter()) {
        ...
        if (message.dailyYield !== undefined) {
            common_1.MoneyValue.encode(message.dailyYield, writer.uint32(250).fork()).join();
        }
        return writer;
    },
    decode(input, length) {
    ...
    create(base) {
        return exports.PortfolioPosition.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b, _c, _d, _e;
        const message = createBasePortfolioPosition();
        ...
        message.quantityLots = (object.quantityLots !== undefined && object.quantityLots !== null)
            ...
            : undefined;
        message.blocked = (_c = object.blocked) !== null && _c !== void 0 ? _c : false;
        message.blockedLots = (object.blockedLots !== undefined && object.blockedLots !== null)
            ...
            : undefined;
        message.positionUid = (_d = object.positionUid) !== null && _d !== void 0 ? _d : "";
...
exports.VirtualPortfolioPosition = {
    ...
    create(base) {
        return exports.VirtualPortfolioPosition.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b, _c, _d, _e;
        const message = createBaseVirtualPortfolioPosition();
        message.positionUid = (_a = object.positionUid) !== null && _a !== void 0 ? _a : "";
        message.instrumentUid = (_b = object.instrumentUid) !== null && _b !== void 0 ? _b : "";
        message.figi = (_c = object.figi) !== null && _c !== void 0 ? _c : "";
        message.instrumentType = (_d = object.instrumentType) !== null && _d !== void 0 ? _d : "";
        message.quantity = (object.quantity !== undefined && object.quantity !== null)
            ? common_1.Quotation.fromPartial(object.quantity)
            : undefined;
        message.averagePositionPrice = (object.averagePositionPrice !== undefined && object.averagePositionPrice !== null)
        ...
        message.expectedYieldFifo = (object.expectedYieldFifo !== undefined && object.expectedYieldFifo !== null)
            ? common_1.Quotation.fromPartial(object.expectedYieldFifo)
            : undefined;
        message.expireDate = (_e = object.expireDate) !== null && _e !== void 0 ? _e : undefined;
        message.currentPrice = (object.currentPrice !== undefined && object.currentPrice !== null)
            ? common_1.MoneyValue.fromPartial(object.currentPrice)
            : undefined;
        message.averagePositionPriceFifo =
...
exports.PositionsSecurities = {
    ...
    create(base) {
        return exports.PositionsSecurities.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b, _c, _d, _e, _f, _g;
        const message = createBasePositionsSecurities();
        ...
        message.positionUid = (_d = object.positionUid) !== null && _d !== void 0 ? _d : "";
        message.instrumentUid = (_e = object.instrumentUid) !== null && _e !== void 0 ? _e : "";
        message.exchangeBlocked = (_f = object.exchangeBlocked) !== null && _f !== void 0 ? _f : false;
        message.instrumentType = (_g = object.instrumentType) !== null && _g !== void 0 ? _g : "";
        return message;
    },
};
...
exports.PositionsFutures = {
    ...
    create(base) {
        return exports.PositionsFutures.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b, _c, _d, _e;
        const message = createBasePositionsFutures();
...
exports.PositionsOptions = {
    ...
    create(base) {
        return exports.PositionsOptions.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b, _c, _d;
        const message = createBasePositionsOptions();
        message.positionUid = (_a = object.positionUid) !== null && _a !== void 0 ? _a : "";
        message.instrumentUid = (_b = object.instrumentUid) !== null && _b !== void 0 ? _b : "";
        message.blocked = (_c = object.blocked) !== null && _c !== void 0 ? _c : 0;
...
exports.BrokerReportRequest = {
    ...
    create(base) {
        return exports.BrokerReportRequest.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        const message = createBaseBrokerReportRequest();
...
exports.BrokerReportResponse = {
    ...
    create(base) {
        return exports.BrokerReportResponse.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        const message = createBaseBrokerReportResponse();
...
exports.GenerateBrokerReportRequest = {
    ...
    create(base) {
        return exports.GenerateBrokerReportRequest.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b, _c;
        const message = createBaseGenerateBrokerReportRequest();
...
exports.GenerateBrokerReportResponse = {
    ...
    create(base) {
        return exports.GenerateBrokerReportResponse.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a;
        const message = createBaseGenerateBrokerReportResponse();
...
exports.GetBrokerReportRequest = {
    ...
    create(base) {
        return exports.GetBrokerReportRequest.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b;
        const message = createBaseGetBrokerReportRequest();
...
exports.GetBrokerReportResponse = {
    ...
    fromJSON(object) {
        return {
            brokerReport: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.brokerReport)
    ...
    toJSON(message) {
        var _a;
        const obj = {};
        if ((_a = message.brokerReport) === null || _a === void 0 ? void 0 : _a.length) {
    ...
    create(base) {
        return exports.GetBrokerReportResponse.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b, _c, _d;
        const message = createBaseGetBrokerReportResponse();
...
exports.BrokerReport = {
    ...
    create(base) {
        return exports.BrokerReport.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
...
exports.GetDividendsForeignIssuerRequest = {
    ...
    create(base) {
        return exports.GetDividendsForeignIssuerRequest.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        const message = createBaseGetDividendsForeignIssuerRequest();
...
exports.GetDividendsForeignIssuerResponse = {
    ...
    create(base) {
        return exports.GetDividendsForeignIssuerResponse.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        const message = createBaseGetDividendsForeignIssuerResponse();
...
exports.GenerateDividendsForeignIssuerReportRequest = {
    ...
    create(base) {
        return exports.GenerateDividendsForeignIssuerReportRequest.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b, _c;
        const message = createBaseGenerateDividendsForeignIssuerReportRequest();
...
exports.GetDividendsForeignIssuerReportRequest = {
    ...
    create(base) {
        return exports.GetDividendsForeignIssuerReportRequest.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b;
        const message = createBaseGetDividendsForeignIssuerReportRequest();
...
exports.GenerateDividendsForeignIssuerReportResponse = {
    ...
    create(base) {
        return exports.GenerateDividendsForeignIssuerReportResponse.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a;
        const message = createBaseGenerateDividendsForeignIssuerReportResponse();
...
exports.GetDividendsForeignIssuerReportResponse = {
    ...
    fromJSON(object) {
        return {
            dividendsForeignIssuerReport: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.dividendsForeignIssuerReport)
    ...
    toJSON(message) {
        var _a;
        const obj = {};
        if ((_a = message.dividendsForeignIssuerReport) === null || _a === void 0 ? void 0 : _a.length) {
    ...
    create(base) {
        return exports.GetDividendsForeignIssuerReportResponse.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b, _c, _d;
        const message = createBaseGetDividendsForeignIssuerReportResponse();
...
exports.DividendsForeignIssuerReport = {
    ...
    create(base) {
        return exports.DividendsForeignIssuerReport.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b, _c, _d, _e, _f, _g;
        const message = createBaseDividendsForeignIssuerReport();
...
exports.PortfolioStreamRequest = {
    ...
    fromJSON(object) {
        return {
            accounts: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.accounts) ? object.accounts.map((e) => globalThis.String(e)) : [],
    ...
    create(base) {
        return exports.PortfolioStreamRequest.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a;
        const message = createBasePortfolioStreamRequest();
...
exports.PortfolioStreamResponse = {
    ...
    create(base) {
        return exports.PortfolioStreamResponse.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        const message = createBasePortfolioStreamResponse();
...
exports.PortfolioSubscriptionResult = {
    ...
    create(base) {
        return exports.PortfolioSubscriptionResult.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b, _c;
        const message = createBasePortfolioSubscriptionResult();
        message.accounts = ((_a = object.accounts) === null || _a === void 0 ? void 0 : _a.map((e) => exports.AccountSubscriptionStatus.fromPartial(e))) || [];
        message.trackingId = (_b = object.trackingId) !== null && _b !== void 0 ? _b : "";
        message.streamId = (_c = object.streamId) !== null && _c !== void 0 ? _c : "";
        return message;
    },
};
...
exports.AccountSubscriptionStatus = {
    ...
    create(base) {
        return exports.AccountSubscriptionStatus.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b;
        const message = createBaseAccountSubscriptionStatus();
...
exports.GetOperationsByCursorRequest = {
    ...
    fromJSON(object) {
        return {
            ...
            operationTypes: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.operationTypes)
    ...
    toJSON(message) {
        ...
        if ((_a = message.operationTypes) === null || _a === void 0 ? void 0 : _a.length) {
    ...
    create(base) {
        return exports.GetOperationsByCursorRequest.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        ...
        message.cursor = (_e = object.cursor) !== null && _e !== void 0 ? _e : undefined;
        message.limit = (_f = object.limit) !== null && _f !== void 0 ? _f : undefined;
        message.operationTypes = ((_g = object.operationTypes) === null || _g === void 0 ? void 0 : _g.map((e) => e)) || [];
        message.state = (_h = object.state) !== null && _h !== void 0 ? _h : undefined;
        message.withoutCommissions = (_j = object.withoutCommissions) !== null && _j !== void 0 ? _j : undefined;
        message.withoutTrades = (_k = object.withoutTrades) !== null && _k !== void 0 ? _k : undefined;
        message.withoutOvernights = (_l = object.withoutOvernights) !== null && _l !== void 0 ? _l : undefined;
        return message;
    },
};
...
exports.GetOperationsByCursorResponse = {
    ...
    fromJSON(object) {
        return {
            ...
            items: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.items) ? object.items.map((e) => exports.OperationItem.fromJSON(e)) : [],
        };
    },
    toJSON(message) {
        var _a;
    ...
    create(base) {
        return exports.GetOperationsByCursorResponse.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b, _c;
        const message = createBaseGetOperationsByCursorResponse();
        message.hasNext = (_a = object.hasNext) !== null && _a !== void 0 ? _a : false;
        message.nextCursor = (_b = object.nextCursor) !== null && _b !== void 0 ? _b : "";
        message.items = ((_c = object.items) === null || _c === void 0 ? void 0 : _c.map((e) => exports.OperationItem.fromPartial(e))) || [];
        return message;
    },
};
...
exports.OperationItem = {
    encode(message, writer = new wire_1.BinaryWriter()) {
        ...
        for (const v of message.childOperations) {
            exports.ChildOperationItem.encode(v, writer.uint32(522).fork()).join();
        }
        return writer;
    },
    decode(input, length) {
    ...
    toJSON(message) {
        ...
        if ((_a = message.childOperations) === null || _a === void 0 ? void 0 : _a.length) {
            obj.childOperations = message.childOperations.map((e) => exports.ChildOperationItem.toJSON(e));
        }
        return obj;
    },
    create(base) {
        return exports.OperationItem.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b, _c, _d, _e, _f, _g, _h, _j, _k, _l, _m, _o, _p, _q, _r, _s, _t, _u, _v, _w;
        const message = createBaseOperationItem();
        message.cursor = (_a = object.cursor) !== null && _a !== void 0 ? _a : "";
        message.brokerAccountId = (_b = object.brokerAccountId) !== null && _b !== void 0 ? _b : "";
        message.id = (_c = object.id) !== null && _c !== void 0 ? _c : "";
        message.parentOperationId = (_d = object.parentOperationId) !== null && _d !== void 0 ? _d : "";
        message.name = (_e = object.name) !== null && _e !== void 0 ? _e : "";
        message.date = (_f = object.date) !== null && _f !== void 0 ? _f : undefined;
        message.type = (_g = object.type) !== null && _g !== void 0 ? _g : 0;
        message.description = (_h = object.description) !== null && _h !== void 0 ? _h : "";
        message.state = (_j = object.state) !== null && _j !== void 0 ? _j : 0;
        message.instrumentUid = (_k = object.instrumentUid) !== null && _k !== void 0 ? _k : "";
        message.figi = (_l = object.figi) !== null && _l !== void 0 ? _l : "";
        message.instrumentType = (_m = object.instrumentType) !== null && _m !== void 0 ? _m : "";
        message.instrumentKind = (_o = object.instrumentKind) !== null && _o !== void 0 ? _o : 0;
        message.positionUid = (_p = object.positionUid) !== null && _p !== void 0 ? _p : "";
        message.payment = (object.payment !== undefined && object.payment !== null)
            ? common_1.MoneyValue.fromPartial(object.payment)
            : undefined;
        ...
        message.accruedInt = (object.accruedInt !== undefined && object.accruedInt !== null)
            ...
            : undefined;
        message.quantity = (_q = object.quantity) !== null && _q !== void 0 ? _q : 0;
        message.quantityRest = (_r = object.quantityRest) !== null && _r !== void 0 ? _r : 0;
        message.quantityDone = (_s = object.quantityDone) !== null && _s !== void 0 ? _s : 0;
        message.cancelDateTime = (_t = object.cancelDateTime) !== null && _t !== void 0 ? _t : undefined;
        message.cancelReason = (_u = object.cancelReason) !== null && _u !== void 0 ? _u : "";
        message.tradesInfo = (object.tradesInfo !== undefined && object.tradesInfo !== null)
            ...
            : undefined;
        message.assetUid = (_v = object.assetUid) !== null && _v !== void 0 ? _v : "";
        message.childOperations = ((_w = object.childOperations) === null || _w === void 0 ? void 0 : _w.map((e) => exports.ChildOperationItem.fromPartial(e))) || [];
        return message;
    },
};
...
exports.OperationItemTrades = {
    ...
    create(base) {
        return exports.OperationItemTrades.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a;
        const message = createBaseOperationItemTrades();
        message.trades = ((_a = object.trades) === null || _a === void 0 ? void 0 : _a.map((e) => exports.OperationItemTrade.fromPartial(e))) || [];
        return message;
    },
};
...
exports.OperationItemTrade = {
    ...
    create(base) {
        return exports.OperationItemTrade.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b, _c;
        const message = createBaseOperationItemTrade();
        message.num = (_a = object.num) !== null && _a !== void 0 ? _a : "";
...
exports.PositionsStreamRequest = {
    ...
    create(base) {
        return exports.PositionsStreamRequest.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b;
        const message = createBasePositionsStreamRequest();
        message.accounts = ((_a = object.accounts) === null || _a === void 0 ? void 0 : _a.map((e) => e)) || [];
        message.withInitialPositions = (_b = object.withInitialPositions) !== null && _b !== void 0 ? _b : false;
        message.pingSettings = (object.pingSettings !== undefined && object.pingSettings !== null)
            ? common_1.PingDelaySettings.fromPartial(object.pingSettings)
            : undefined;
        return message;
...
exports.PositionsStreamResponse = {
    encode(message, writer = new wire_1.BinaryWriter()) {
        ...
        if (message.initialPositions !== undefined) {
            exports.PositionsResponse.encode(message.initialPositions, writer.uint32(42).fork()).join();
        }
        return writer;
    },
    decode(input, length) {
    ...
    create(base) {
        return exports.PositionsStreamResponse.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        const message = createBasePositionsStreamResponse();
        message.subscriptions = (object.subscriptions !== undefined && object.subscriptions !== null)
        ...
        message.initialPositions = (object.initialPositions !== undefined && object.initialPositions !== null)
            ? exports.PositionsResponse.fromPartial(object.initialPositions)
            : undefined;
        return message;
    },
};
...
exports.PositionsSubscriptionResult = {
    ...
    create(base) {
        return exports.PositionsSubscriptionResult.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b, _c;
        const message = createBasePositionsSubscriptionResult();
        message.accounts = ((_a = object.accounts) === null || _a === void 0 ? void 0 : _a.map((e) => exports.PositionsSubscriptionStatus.fromPartial(e))) || [];
        message.trackingId = (_b = object.trackingId) !== null && _b !== void 0 ? _b : "";
        message.streamId = (_c = object.streamId) !== null && _c !== void 0 ? _c : "";
        return message;
    },
...
exports.PositionsSubscriptionStatus = {
    ...
    create(base) {
        return exports.PositionsSubscriptionStatus.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b;
        const message = createBasePositionsSubscriptionStatus();
...
exports.PositionData = {
    ...
    fromJSON(object) {
        return {
            accountId: isSet(object.accountId) ? globalThis.String(object.accountId) : "",
            money: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.money) ? object.money.map((e) => exports.PositionsMoney.fromJSON(e)) : [],
            securities: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.securities)
                ? object.securities.map((e) => exports.PositionsSecurities.fromJSON(e))
                : [],
            futures: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.futures)
    ...
    toJSON(message) {
        ...
        if ((_b = message.securities) === null || _b === void 0 ? void 0 : _b.length) {
            obj.securities = message.securities.map((e) => exports.PositionsSecurities.toJSON(e));
        }
        if ((_c = message.futures) === null || _c === void 0 ? void 0 : _c.length) {
            obj.futures = message.futures.map((e) => exports.PositionsFutures.toJSON(e));
        }
        if ((_d = message.options) === null || _d === void 0 ? void 0 : _d.length) {
            obj.options = message.options.map((e) => exports.PositionsOptions.toJSON(e));
        }
        if (message.date !== undefined) {
            obj.date = message.date.toISOString();
    ...
    create(base) {
        return exports.PositionData.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b, _c, _d, _e, _f;
        const message = createBasePositionData();
        message.accountId = (_a = object.accountId) !== null && _a !== void 0 ? _a : "";
        message.money = ((_b = object.money) === null || _b === void 0 ? void 0 : _b.map((e) => exports.PositionsMoney.fromPartial(e))) || [];
        message.securities = ((_c = object.securities) === null || _c === void 0 ? void 0 : _c.map((e) => exports.PositionsSecurities.fromPartial(e))) || [];
        message.futures = ((_d = object.futures) === null || _d === void 0 ? void 0 : _d.map((e) => exports.PositionsFutures.fromPartial(e))) || [];
        message.options = ((_e = object.options) === null || _e === void 0 ? void 0 : _e.map((e) => exports.PositionsOptions.fromPartial(e))) || [];
        message.date = (_f = object.date) !== null && _f !== void 0 ? _f : undefined;
        return message;
    },
};
...
exports.PositionsMoney = {
    ...
    create(base) {
        return exports.PositionsMoney.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        const message = createBasePositionsMoney();
...
exports.ChildOperationItem = {
    encode(message, writer = new wire_1.BinaryWriter()) {
        ...
        if (message.payment !== undefined) {
            common_1.MoneyValue.encode(message.payment, writer.uint32(18).fork()).join();
        }
        return writer;
    },
    decode(input, length) {
    ...
    create(base) {
        return exports.ChildOperationItem.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a;
        const message = createBaseChildOperationItem();
        message.instrumentUid = (_a = object.instrumentUid) !== null && _a !== void 0 ? _a : "";
        message.payment = (object.payment !== undefined && object.payment !== null)
            ? common_1.MoneyValue.fromPartial(object.payment)
            : undefined;
        return message;
