...
export declare const PingDelaySettings: MessageFns<PingDelaySettings>;
export declare const Ping: MessageFns<Ping>;
export declare const Page: MessageFns<Page>;
export declare const PageResponse: MessageFns<PageResponse>;
export declare const ResponseMetadata: MessageFns<ResponseMetadata>;
export declare const BrandData: MessageFns<BrandData>;
