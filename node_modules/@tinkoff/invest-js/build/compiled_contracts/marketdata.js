...
exports.MarketDataRequest = {
    encode(message, writer = new wire_1.BinaryWriter()) {
        ...
        if (message.ping !== undefined) {
            common_1.PingRequest.encode(message.ping, writer.uint32(58).fork()).join();
        }
        if (message.pingSettings !== undefined) {
            common_1.PingDelaySettings.encode(message.pingSettings, writer.uint32(122).fork()).join();
        }
        return writer;
    },
    decode(input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 7: {
                    ...
                    message.ping = common_1.PingRequest.decode(reader, reader.uint32());
                    continue;
                }
                case 15: {
                    if (tag !== 122) {
                    ...
                    message.pingSettings = common_1.PingDelaySettings.decode(reader, reader.uint32());
                    continue;
                }
            }
            if ((tag & 7) === 4 || tag === 0) {
    ...
    fromJSON(object) {
        return {
            ...
            getMySubscriptions: isSet(object.getMySubscriptions)
                ...
                : undefined,
            ping: isSet(object.ping) ? common_1.PingRequest.fromJSON(object.ping) : undefined,
            pingSettings: isSet(object.pingSettings) ? common_1.PingDelaySettings.fromJSON(object.pingSettings) : undefined,
        };
    },
    toJSON(message) {
        const obj = {};
        ...
        if (message.ping !== undefined) {
            obj.ping = common_1.PingRequest.toJSON(message.ping);
        }
        if (message.pingSettings !== undefined) {
            obj.pingSettings = common_1.PingDelaySettings.toJSON(message.pingSettings);
        }
        return obj;
    },
    create(base) {
        return exports.MarketDataRequest.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        const message = createBaseMarketDataRequest();
        ...
        message.ping = (object.ping !== undefined && object.ping !== null)
            ? common_1.PingRequest.fromPartial(object.ping)
            : undefined;
        message.pingSettings = (object.pingSettings !== undefined && object.pingSettings !== null)
            ? common_1.PingDelaySettings.fromPartial(object.pingSettings)
            : undefined;
        return message;
    },
};
...
exports.MarketDataServerSideStreamRequest = {
    ...
    create(base) {
        return exports.MarketDataServerSideStreamRequest.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        const message = createBaseMarketDataServerSideStreamRequest();
        message.subscribeCandlesRequest =
...
exports.MarketDataResponse = {
    ...
    create(base) {
        return exports.MarketDataResponse.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        const message = createBaseMarketDataResponse();
...
exports.SubscribeCandlesRequest = {
    ...
    fromJSON(object) {
        return {
            ...
            instruments: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.instruments)
    ...
    toJSON(message) {
        ...
        if ((_a = message.instruments) === null || _a === void 0 ? void 0 : _a.length) {
    ...
    create(base) {
        return exports.SubscribeCandlesRequest.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b, _c, _d;
        const message = createBaseSubscribeCandlesRequest();
        ...
        message.waitingClose = (_c = object.waitingClose) !== null && _c !== void 0 ? _c : false;
        message.candleSourceType = (_d = object.candleSourceType) !== null && _d !== void 0 ? _d : undefined;
        return message;
    },
};
...
exports.CandleInstrument = {
    ...
    create(base) {
        return exports.CandleInstrument.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b, _c;
        const message = createBaseCandleInstrument();
        ...
        message.instrumentId = (_c = object.instrumentId) !== null && _c !== void 0 ? _c : "";
        return message;
    },
};
...
exports.SubscribeCandlesResponse = {
    ...
    fromJSON(object) {
        return {
            ...
            candlesSubscriptions: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.candlesSubscriptions)
    ...
    toJSON(message) {
        ...
        if ((_a = message.candlesSubscriptions) === null || _a === void 0 ? void 0 : _a.length) {
            obj.candlesSubscriptions = message.candlesSubscriptions.map((e) => exports.CandleSubscription.toJSON(e));
        }
        return obj;
    },
    create(base) {
        return exports.SubscribeCandlesResponse.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b;
        const message = createBaseSubscribeCandlesResponse();
...
exports.CandleSubscription = {
    ...
    create(base) {
        return exports.CandleSubscription.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        ...
        message.instrumentUid = (_d = object.instrumentUid) !== null && _d !== void 0 ? _d : "";
        message.waitingClose = (_e = object.waitingClose) !== null && _e !== void 0 ? _e : false;
        message.streamId = (_f = object.streamId) !== null && _f !== void 0 ? _f : "";
        message.subscriptionId = (_g = object.subscriptionId) !== null && _g !== void 0 ? _g : "";
        message.candleSourceType = (_h = object.candleSourceType) !== null && _h !== void 0 ? _h : undefined;
        return message;
    },
};
...
exports.SubscribeOrderBookRequest = {
    ...
    create(base) {
        return exports.SubscribeOrderBookRequest.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b;
        const message = createBaseSubscribeOrderBookRequest();
...
exports.OrderBookInstrument = {
    ...
    create(base) {
        return exports.OrderBookInstrument.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b, _c, _d;
        const message = createBaseOrderBookInstrument();
        ...
        message.instrumentId = (_c = object.instrumentId) !== null && _c !== void 0 ? _c : "";
        message.orderBookType = (_d = object.orderBookType) !== null && _d !== void 0 ? _d : 0;
        return message;
    },
};
...
exports.SubscribeOrderBookResponse = {
    ...
    fromJSON(object) {
        return {
            trackingId: isSet(object.trackingId) ? globalThis.String(object.trackingId) : "",
            orderBookSubscriptions: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.orderBookSubscriptions)
    ...
    toJSON(message) {
        ...
        if ((_a = message.orderBookSubscriptions) === null || _a === void 0 ? void 0 : _a.length) {
            obj.orderBookSubscriptions = message.orderBookSubscriptions.map((e) => exports.OrderBookSubscription.toJSON(e));
        }
        return obj;
    },
    create(base) {
        return exports.SubscribeOrderBookResponse.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b;
        const message = createBaseSubscribeOrderBookResponse();
        message.trackingId = (_a = object.trackingId) !== null && _a !== void 0 ? _a : "";
        message.orderBookSubscriptions = ((_b = object.orderBookSubscriptions) === null || _b === void 0 ? void 0 : _b.map((e) => exports.OrderBookSubscription.fromPartial(e))) ||
            [];
        return message;
    },
};
...
exports.OrderBookSubscription = {
    ...
    create(base) {
        return exports.OrderBookSubscription.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        ...
        message.subscriptionStatus = (_c = object.subscriptionStatus) !== null && _c !== void 0 ? _c : 0;
        message.instrumentUid = (_d = object.instrumentUid) !== null && _d !== void 0 ? _d : "";
        message.streamId = (_e = object.streamId) !== null && _e !== void 0 ? _e : "";
        message.subscriptionId = (_f = object.subscriptionId) !== null && _f !== void 0 ? _f : "";
        message.orderBookType = (_g = object.orderBookType) !== null && _g !== void 0 ? _g : 0;
        return message;
    },
};
...
exports.SubscribeTradesRequest = {
    ...
    create(base) {
        return exports.SubscribeTradesRequest.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b, _c;
        const message = createBaseSubscribeTradesRequest();
        ...
        message.tradeSource = (_c = object.tradeSource) !== null && _c !== void 0 ? _c : 0;
        return message;
    },
};
...
exports.TradeInstrument = {
    ...
    create(base) {
        return exports.TradeInstrument.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b;
        const message = createBaseTradeInstrument();
        message.figi = (_a = object.figi) !== null && _a !== void 0 ? _a : "";
        message.instrumentId = (_b = object.instrumentId) !== null && _b !== void 0 ? _b : "";
        return message;
    },
};
...
exports.SubscribeTradesResponse = {
    ...
    fromJSON(object) {
        return {
            trackingId: isSet(object.trackingId) ? globalThis.String(object.trackingId) : "",
            tradeSubscriptions: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.tradeSubscriptions)
    ...
    toJSON(message) {
        ...
        if ((_a = message.tradeSubscriptions) === null || _a === void 0 ? void 0 : _a.length) {
    ...
    create(base) {
        return exports.SubscribeTradesResponse.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b, _c;
        const message = createBaseSubscribeTradesResponse();
...
exports.TradeSubscription = {
    ...
    create(base) {
        return exports.TradeSubscription.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b, _c, _d, _e;
        const message = createBaseTradeSubscription();
        ...
        message.instrumentUid = (_c = object.instrumentUid) !== null && _c !== void 0 ? _c : "";
        message.streamId = (_d = object.streamId) !== null && _d !== void 0 ? _d : "";
        message.subscriptionId = (_e = object.subscriptionId) !== null && _e !== void 0 ? _e : "";
        return message;
    },
};
...
exports.SubscribeInfoRequest = {
    ...
    create(base) {
        return exports.SubscribeInfoRequest.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b;
        const message = createBaseSubscribeInfoRequest();
...
exports.InfoInstrument = {
    ...
    create(base) {
        return exports.InfoInstrument.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b;
        const message = createBaseInfoInstrument();
...
exports.SubscribeInfoResponse = {
    ...
    fromJSON(object) {
        return {
            trackingId: isSet(object.trackingId) ? globalThis.String(object.trackingId) : "",
            infoSubscriptions: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.infoSubscriptions)
    ...
    toJSON(message) {
        ...
        if ((_a = message.infoSubscriptions) === null || _a === void 0 ? void 0 : _a.length) {
            obj.infoSubscriptions = message.infoSubscriptions.map((e) => exports.InfoSubscription.toJSON(e));
        }
        return obj;
    },
    create(base) {
        return exports.SubscribeInfoResponse.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b;
        const message = createBaseSubscribeInfoResponse();
...
exports.InfoSubscription = {
    ...
    create(base) {
        return exports.InfoSubscription.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b, _c, _d, _e;
        const message = createBaseInfoSubscription();
...
exports.SubscribeLastPriceRequest = {
    ...
    create(base) {
        return exports.SubscribeLastPriceRequest.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b;
        const message = createBaseSubscribeLastPriceRequest();
...
exports.LastPriceInstrument = {
    ...
    create(base) {
        return exports.LastPriceInstrument.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b;
        const message = createBaseLastPriceInstrument();
...
exports.SubscribeLastPriceResponse = {
    ...
    fromJSON(object) {
        return {
            trackingId: isSet(object.trackingId) ? globalThis.String(object.trackingId) : "",
            lastPriceSubscriptions: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.lastPriceSubscriptions)
    ...
    toJSON(message) {
        ...
        if ((_a = message.lastPriceSubscriptions) === null || _a === void 0 ? void 0 : _a.length) {
            obj.lastPriceSubscriptions = message.lastPriceSubscriptions.map((e) => exports.LastPriceSubscription.toJSON(e));
        }
        return obj;
    },
    create(base) {
        return exports.SubscribeLastPriceResponse.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b;
        const message = createBaseSubscribeLastPriceResponse();
        message.trackingId = (_a = object.trackingId) !== null && _a !== void 0 ? _a : "";
        message.lastPriceSubscriptions = ((_b = object.lastPriceSubscriptions) === null || _b === void 0 ? void 0 : _b.map((e) => exports.LastPriceSubscription.fromPartial(e))) ||
            [];
        return message;
    },
};
...
exports.LastPriceSubscription = {
    ...
    create(base) {
        return exports.LastPriceSubscription.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b, _c, _d, _e;
        const message = createBaseLastPriceSubscription();
...
exports.Candle = {
    ...
    create(base) {
        return exports.Candle.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b, _c, _d, _e, _f, _g;
        const message = createBaseCandle();
        ...
        message.instrumentUid = (_f = object.instrumentUid) !== null && _f !== void 0 ? _f : "";
        message.candleSourceType = (_g = object.candleSourceType) !== null && _g !== void 0 ? _g : 0;
        return message;
    },
};
...
exports.OrderBook = {
    ...
    fromJSON(object) {
        return {
            ...
            bids: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.bids) ? object.bids.map((e) => exports.Order.fromJSON(e)) : [],
            asks: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.asks) ? object.asks.map((e) => exports.Order.fromJSON(e)) : [],
            time: isSet(object.time) ? fromJsonTimestamp(object.time) : undefined,
    ...
    toJSON(message) {
        ...
        if ((_b = message.asks) === null || _b === void 0 ? void 0 : _b.length) {
    ...
    fromPartial(object) {
        ...
        message.limitDown = (object.limitDown !== undefined && object.limitDown !== null)
            ...
            : undefined;
        message.instrumentUid = (_g = object.instrumentUid) !== null && _g !== void 0 ? _g : "";
        message.orderBookType = (_h = object.orderBookType) !== null && _h !== void 0 ? _h : 0;
        return message;
    },
};
...
exports.Trade = {
    ...
    create(base) {
        return exports.Trade.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        ...
        message.time = (_d = object.time) !== null && _d !== void 0 ? _d : undefined;
        message.instrumentUid = (_e = object.instrumentUid) !== null && _e !== void 0 ? _e : "";
        message.tradeSource = (_f = object.tradeSource) !== null && _f !== void 0 ? _f : 0;
        return message;
    },
};
...
exports.TradingStatus = {
    ...
    create(base) {
        return exports.TradingStatus.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b, _c, _d, _e, _f;
        const message = createBaseTradingStatus();
...
exports.GetCandlesRequest = {
    ...
    create(base) {
        return exports.GetCandlesRequest.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b, _c, _d, _e, _f, _g;
        const message = createBaseGetCandlesRequest();
        message.figi = (_a = object.figi) !== null && _a !== void 0 ? _a : undefined;
        ...
        message.instrumentId = (_e = object.instrumentId) !== null && _e !== void 0 ? _e : undefined;
        message.candleSourceType = (_f = object.candleSourceType) !== null && _f !== void 0 ? _f : undefined;
...
exports.GetCandlesResponse = {
    ...
    fromJSON(object) {
        return {
            candles: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.candles)
    ...
    toJSON(message) {
        var _a;
        const obj = {};
        if ((_a = message.candles) === null || _a === void 0 ? void 0 : _a.length) {
            obj.candles = message.candles.map((e) => exports.HistoricCandle.toJSON(e));
        }
        return obj;
    },
    create(base) {
        return exports.GetCandlesResponse.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a;
        const message = createBaseGetCandlesResponse();
...
exports.HistoricCandle = {
    ...
    create(base) {
        return exports.HistoricCandle.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b, _c, _d;
        const message = createBaseHistoricCandle();
        ...
        message.candleSourceType = (_d = object.candleSourceType) !== null && _d !== void 0 ? _d : 0;
        return message;
    },
};
...
exports.GetLastPricesRequest = {
    ...
    fromJSON(object) {
        return {
            figi: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.figi) ? object.figi.map((e) => globalThis.String(e)) : [],
            instrumentId: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.instrumentId)
            ...
            instrumentStatus: isSet(object.instrumentStatus) ? (0, common_1.instrumentStatusFromJSON)(object.instrumentStatus) : undefined,
        };
    },
    toJSON(message) {
        var _a, _b;
        const obj = {};
        if ((_a = message.figi) === null || _a === void 0 ? void 0 : _a.length) {
            obj.figi = message.figi;
        }
        if ((_b = message.instrumentId) === null || _b === void 0 ? void 0 : _b.length) {
            obj.instrumentId = message.instrumentId;
        }
        if (message.lastPriceType !== 0) {
        ...
        if (message.instrumentStatus !== undefined) {
            obj.instrumentStatus = (0, common_1.instrumentStatusToJSON)(message.instrumentStatus);
        }
        return obj;
    },
    create(base) {
        return exports.GetLastPricesRequest.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b, _c, _d;
        const message = createBaseGetLastPricesRequest();
        message.figi = ((_a = object.figi) === null || _a === void 0 ? void 0 : _a.map((e) => e)) || [];
        message.instrumentId = ((_b = object.instrumentId) === null || _b === void 0 ? void 0 : _b.map((e) => e)) || [];
        message.lastPriceType = (_c = object.lastPriceType) !== null && _c !== void 0 ? _c : 0;
        message.instrumentStatus = (_d = object.instrumentStatus) !== null && _d !== void 0 ? _d : undefined;
        return message;
    },
};
...
exports.GetLastPricesResponse = {
    ...
    fromJSON(object) {
        return {
            lastPrices: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.lastPrices)
    ...
    toJSON(message) {
        var _a;
        const obj = {};
        if ((_a = message.lastPrices) === null || _a === void 0 ? void 0 : _a.length) {
            obj.lastPrices = message.lastPrices.map((e) => exports.LastPrice.toJSON(e));
        }
        return obj;
    },
    create(base) {
        return exports.GetLastPricesResponse.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a;
        const message = createBaseGetLastPricesResponse();
...
exports.LastPrice = {
    ...
    create(base) {
        return exports.LastPrice.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b, _c, _d;
        const message = createBaseLastPrice();
        ...
        message.time = (_b = object.time) !== null && _b !== void 0 ? _b : undefined;
        message.instrumentUid = (_c = object.instrumentUid) !== null && _c !== void 0 ? _c : "";
        message.lastPriceType = (_d = object.lastPriceType) !== null && _d !== void 0 ? _d : 0;
        return message;
    },
};
...
exports.GetOrderBookRequest = {
    ...
    create(base) {
        return exports.GetOrderBookRequest.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b, _c;
        const message = createBaseGetOrderBookRequest();
        message.figi = (_a = object.figi) !== null && _a !== void 0 ? _a : undefined;
        message.depth = (_b = object.depth) !== null && _b !== void 0 ? _b : 0;
        message.instrumentId = (_c = object.instrumentId) !== null && _c !== void 0 ? _c : undefined;
        return message;
    },
};
...
exports.GetOrderBookResponse = {
    ...
    create(base) {
        return exports.GetOrderBookResponse.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b, _c, _d, _e, _f, _g, _h;
        const message = createBaseGetOrderBookResponse();
        ...
        message.limitDown = (object.limitDown !== undefined && object.limitDown !== null)
            ? common_1.Quotation.fromPartial(object.limitDown)
            : undefined;
        message.lastPriceTs = (_e = object.lastPriceTs) !== null && _e !== void 0 ? _e : undefined;
        message.closePriceTs = (_f = object.closePriceTs) !== null && _f !== void 0 ? _f : undefined;
        message.orderbookTs = (_g = object.orderbookTs) !== null && _g !== void 0 ? _g : undefined;
        message.instrumentUid = (_h = object.instrumentUid) !== null && _h !== void 0 ? _h : "";
        return message;
    },
};
...
exports.GetTradingStatusRequest = {
    ...
    create(base) {
        return exports.GetTradingStatusRequest.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b;
        const message = createBaseGetTradingStatusRequest();
        message.figi = (_a = object.figi) !== null && _a !== void 0 ? _a : undefined;
        message.instrumentId = (_b = object.instrumentId) !== null && _b !== void 0 ? _b : undefined;
        return message;
    },
};
...
exports.GetTradingStatusesRequest = {
    ...
    toJSON(message) {
        var _a;
        const obj = {};
        if ((_a = message.instrumentId) === null || _a === void 0 ? void 0 : _a.length) {
            obj.instrumentId = message.instrumentId;
        }
        return obj;
    },
    create(base) {
        return exports.GetTradingStatusesRequest.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a;
        const message = createBaseGetTradingStatusesRequest();
        message.instrumentId = ((_a = object.instrumentId) === null || _a === void 0 ? void 0 : _a.map((e) => e)) || [];
        return message;
    },
};
...
exports.GetTradingStatusesResponse = {
    ...
    fromJSON(object) {
        return {
            tradingStatuses: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.tradingStatuses)
    ...
    toJSON(message) {
        var _a;
        const obj = {};
        if ((_a = message.tradingStatuses) === null || _a === void 0 ? void 0 : _a.length) {
            obj.tradingStatuses = message.tradingStatuses.map((e) => exports.GetTradingStatusResponse.toJSON(e));
        }
        return obj;
    },
    create(base) {
        return exports.GetTradingStatusesResponse.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a;
        const message = createBaseGetTradingStatusesResponse();
        message.tradingStatuses = ((_a = object.tradingStatuses) === null || _a === void 0 ? void 0 : _a.map((e) => exports.GetTradingStatusResponse.fromPartial(e))) || [];
        return message;
    },
};
...
exports.GetTradingStatusResponse = {
    ...
    create(base) {
        return exports.GetTradingStatusResponse.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b, _c, _d, _e, _f, _g, _h;
        const message = createBaseGetTradingStatusResponse();
        ...
        message.apiTradeAvailableFlag = (_e = object.apiTradeAvailableFlag) !== null && _e !== void 0 ? _e : false;
        message.instrumentUid = (_f = object.instrumentUid) !== null && _f !== void 0 ? _f : "";
        message.bestpriceOrderAvailableFlag = (_g = object.bestpriceOrderAvailableFlag) !== null && _g !== void 0 ? _g : false;
        message.onlyBestPrice = (_h = object.onlyBestPrice) !== null && _h !== void 0 ? _h : false;
        return message;
    },
};
...
exports.GetLastTradesRequest = {
    ...
    create(base) {
        return exports.GetLastTradesRequest.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b, _c, _d, _e;
        const message = createBaseGetLastTradesRequest();
        ...
        message.from = (_b = object.from) !== null && _b !== void 0 ? _b : undefined;
        message.to = (_c = object.to) !== null && _c !== void 0 ? _c : undefined;
        message.instrumentId = (_d = object.instrumentId) !== null && _d !== void 0 ? _d : undefined;
        message.tradeSource = (_e = object.tradeSource) !== null && _e !== void 0 ? _e : 0;
        return message;
    },
};
...
exports.GetLastTradesResponse = {
    ...
    fromJSON(object) {
        return { trades: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.trades) ? object.trades.map((e) => exports.Trade.fromJSON(e)) : [] };
    },
    toJSON(message) {
        var _a;
        const obj = {};
    ...
    create(base) {
        return exports.GetLastTradesResponse.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a;
        const message = createBaseGetLastTradesResponse();
...
exports.GetMySubscriptions = {
    ...
    create(base) {
        return exports.GetMySubscriptions.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(_) {
        const message = createBaseGetMySubscriptions();
        return message;
...
exports.GetClosePricesRequest = {
    ...
    create(base) {
        return exports.GetClosePricesRequest.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b;
        const message = createBaseGetClosePricesRequest();
        message.instruments = ((_a = object.instruments) === null || _a === void 0 ? void 0 : _a.map((e) => exports.InstrumentClosePriceRequest.fromPartial(e))) || [];
        message.instrumentStatus = (_b = object.instrumentStatus) !== null && _b !== void 0 ? _b : undefined;
        return message;
    },
};
...
exports.InstrumentClosePriceRequest = {
    ...
    create(base) {
        return exports.InstrumentClosePriceRequest.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a;
        const message = createBaseInstrumentClosePriceRequest();
        message.instrumentId = (_a = object.instrumentId) !== null && _a !== void 0 ? _a : "";
        return message;
    },
};
...
exports.GetClosePricesResponse = {
    ...
    fromJSON(object) {
        return {
            closePrices: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.closePrices)
    ...
    toJSON(message) {
        var _a;
        const obj = {};
        if ((_a = message.closePrices) === null || _a === void 0 ? void 0 : _a.length) {
            obj.closePrices = message.closePrices.map((e) => exports.InstrumentClosePriceResponse.toJSON(e));
        }
        return obj;
    },
    create(base) {
        return exports.GetClosePricesResponse.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a;
        const message = createBaseGetClosePricesResponse();
        message.closePrices = ((_a = object.closePrices) === null || _a === void 0 ? void 0 : _a.map((e) => exports.InstrumentClosePriceResponse.fromPartial(e))) || [];
        return message;
    },
};
...
exports.InstrumentClosePriceResponse = {
    encode(message, writer = new wire_1.BinaryWriter()) {
        ...
        if (message.eveningSessionPrice !== undefined) {
            common_1.Quotation.encode(message.eveningSessionPrice, writer.uint32(98).fork()).join();
        }
        if (message.time !== undefined) {
    ...
    create(base) {
        return exports.InstrumentClosePriceResponse.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b, _c;
        const message = createBaseInstrumentClosePriceResponse();
...
exports.GetTechAnalysisRequest = {
    encode(message, writer = new wire_1.BinaryWriter()) {
        ...
        if (message.from !== undefined) {
            timestamp_1.Timestamp.encode(toTimestamp(message.from), writer.uint32(26).fork()).join();
        }
        if (message.to !== undefined) {
            timestamp_1.Timestamp.encode(toTimestamp(message.to), writer.uint32(34).fork()).join();
        }
        if (message.interval !== 0) {
        ...
        if (message.deviation !== undefined) {
            exports.GetTechAnalysisRequest_Deviation.encode(message.deviation, writer.uint32(66).fork()).join();
        }
        if (message.smoothing !== undefined) {
            exports.GetTechAnalysisRequest_Smoothing.encode(message.smoothing, writer.uint32(74).fork()).join();
        }
        return writer;
    },
    decode(input, length) {
    ...
    create(base) {
        return exports.GetTechAnalysisRequest.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b, _c, _d, _e, _f, _g;
        const message = createBaseGetTechAnalysisRequest();
        message.indicatorType = (_a = object.indicatorType) !== null && _a !== void 0 ? _a : 0;
        message.instrumentUid = (_b = object.instrumentUid) !== null && _b !== void 0 ? _b : "";
        message.from = (_c = object.from) !== null && _c !== void 0 ? _c : undefined;
        message.to = (_d = object.to) !== null && _d !== void 0 ? _d : undefined;
        message.interval = (_e = object.interval) !== null && _e !== void 0 ? _e : 0;
        message.typeOfPrice = (_f = object.typeOfPrice) !== null && _f !== void 0 ? _f : 0;
        message.length = (_g = object.length) !== null && _g !== void 0 ? _g : 0;
...
exports.GetTechAnalysisRequest_Smoothing = {
    ...
    create(base) {
        return exports.GetTechAnalysisRequest_Smoothing.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b, _c;
        const message = createBaseGetTechAnalysisRequest_Smoothing();
        message.fastLength = (_a = object.fastLength) !== null && _a !== void 0 ? _a : 0;
        message.slowLength = (_b = object.slowLength) !== null && _b !== void 0 ? _b : 0;
        message.signalSmoothing = (_c = object.signalSmoothing) !== null && _c !== void 0 ? _c : 0;
        return message;
    },
};
...
exports.GetTechAnalysisRequest_Deviation = {
    encode(message, writer = new wire_1.BinaryWriter()) {
        if (message.deviationMultiplier !== undefined) {
            common_1.Quotation.encode(message.deviationMultiplier, writer.uint32(10).fork()).join();
        }
        return writer;
    },
    decode(input, length) {
    ...
    create(base) {
        return exports.GetTechAnalysisRequest_Deviation.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        const message = createBaseGetTechAnalysisRequest_Deviation();
...
exports.GetTechAnalysisResponse = {
    encode(message, writer = new wire_1.BinaryWriter()) {
        for (const v of message.technicalIndicators) {
            exports.GetTechAnalysisResponse_TechAnalysisItem.encode(v, writer.uint32(10).fork()).join();
        }
        return writer;
    },
    decode(input, length) {
    ...
    fromJSON(object) {
        return {
            technicalIndicators: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.technicalIndicators)
    ...
    toJSON(message) {
        var _a;
        const obj = {};
        if ((_a = message.technicalIndicators) === null || _a === void 0 ? void 0 : _a.length) {
            obj.technicalIndicators = message.technicalIndicators.map((e) => exports.GetTechAnalysisResponse_TechAnalysisItem.toJSON(e));
        }
        return obj;
    },
    create(base) {
        return exports.GetTechAnalysisResponse.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a;
        const message = createBaseGetTechAnalysisResponse();
        message.technicalIndicators =
            ((_a = object.technicalIndicators) === null || _a === void 0 ? void 0 : _a.map((e) => exports.GetTechAnalysisResponse_TechAnalysisItem.fromPartial(e))) || [];
        return message;
    },
};
...
exports.GetTechAnalysisResponse_TechAnalysisItem = {
    encode(message, writer = new wire_1.BinaryWriter()) {
        ...
        if (message.middleBand !== undefined) {
            common_1.Quotation.encode(message.middleBand, writer.uint32(18).fork()).join();
        }
        if (message.upperBand !== undefined) {
            common_1.Quotation.encode(message.upperBand, writer.uint32(26).fork()).join();
        }
        if (message.lowerBand !== undefined) {
            common_1.Quotation.encode(message.lowerBand, writer.uint32(34).fork()).join();
        }
        if (message.signal !== undefined) {
            common_1.Quotation.encode(message.signal, writer.uint32(42).fork()).join();
        }
        if (message.macd !== undefined) {
            common_1.Quotation.encode(message.macd, writer.uint32(50).fork()).join();
        }
        return writer;
    },
    decode(input, length) {
    ...
    create(base) {
        return exports.GetTechAnalysisResponse_TechAnalysisItem.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a;
        const message = createBaseGetTechAnalysisResponse_TechAnalysisItem();
