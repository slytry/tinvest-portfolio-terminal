...
exports.SandboxServiceDefinition = exports.SandboxPayInResponse = exports.SandboxPayInRequest = exports.CloseSandboxAccountResponse = exports.CloseSandboxAccountRequest = exports.OpenSandboxAccountResponse = exports.OpenSandboxAccountRequest = void 0;
/* eslint-disable */
...
exports.OpenSandboxAccountRequest = {
    ...
    create(base) {
        return exports.OpenSandboxAccountRequest.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a;
        const message = createBaseOpenSandboxAccountRequest();
...
exports.OpenSandboxAccountResponse = {
    ...
    create(base) {
        return exports.OpenSandboxAccountResponse.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a;
        const message = createBaseOpenSandboxAccountResponse();
...
exports.CloseSandboxAccountRequest = {
    ...
    create(base) {
        return exports.CloseSandboxAccountRequest.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a;
        const message = createBaseCloseSandboxAccountRequest();
...
exports.CloseSandboxAccountResponse = {
    ...
    create(base) {
        return exports.CloseSandboxAccountResponse.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(_) {
        const message = createBaseCloseSandboxAccountResponse();
        return message;
...
exports.SandboxPayInRequest = {
    ...
    create(base) {
        return exports.SandboxPayInRequest.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a;
        const message = createBaseSandboxPayInRequest();
...
exports.SandboxPayInResponse = {
    ...
    create(base) {
        return exports.SandboxPayInResponse.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        const message = createBaseSandboxPayInResponse();
