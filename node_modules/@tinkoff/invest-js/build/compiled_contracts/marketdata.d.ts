...
export declare const GetTechAnalysisRequest: MessageFns<GetTechAnalysisRequest>;
export declare const GetTechAnalysisRequest_Smoothing: MessageFns<GetTechAnalysisRequest_Smoothing>;
export declare const GetTechAnalysisRequest_Deviation: MessageFns<GetTechAnalysisRequest_Deviation>;
export declare const GetTechAnalysisResponse: MessageFns<GetTechAnalysisResponse>;
export declare const GetTechAnalysisResponse_TechAnalysisItem: MessageFns<GetTechAnalysisResponse_TechAnalysisItem>;
...
export declare const MarketDataServiceDefinition: {
    ...
    readonly methods: {
        ...
        readonly getTechAnalysis: {
            ...
            readonly requestType: MessageFns<GetTechAnalysisRequest>;
            readonly requestStream: false;
            readonly responseType: MessageFns<GetTechAnalysisResponse>;
            readonly responseStream: false;
            readonly options: {};
        };
    };
