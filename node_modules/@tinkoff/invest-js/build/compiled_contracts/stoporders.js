...
exports.PostStopOrderRequest = {
    encode(message, writer = new wire_1.BinaryWriter()) {
        ...
        if (message.trailingData !== undefined) {
            exports.PostStopOrderRequest_TrailingData.encode(message.trailingData, writer.uint32(106).fork()).join();
        }
    ...
    create(base) {
        return exports.PostStopOrderRequest.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        ...
        message.instrumentId = (_h = object.instrumentId) !== null && _h !== void 0 ? _h : "";
        message.exchangeOrderType = (_j = object.exchangeOrderType) !== null && _j !== void 0 ? _j : 0;
        message.takeProfitType = (_k = object.takeProfitType) !== null && _k !== void 0 ? _k : 0;
        message.trailingData = (object.trailingData !== undefined && object.trailingData !== null)
            ...
            : undefined;
        message.priceType = (_l = object.priceType) !== null && _l !== void 0 ? _l : 0;
        message.orderId = (_m = object.orderId) !== null && _m !== void 0 ? _m : "";
        return message;
    },
};
...
exports.PostStopOrderRequest_TrailingData = {
    encode(message, writer = new wire_1.BinaryWriter()) {
        if (message.indent !== undefined) {
            common_1.Quotation.encode(message.indent, writer.uint32(10).fork()).join();
        }
        if (message.indentType !== 0) {
            writer.uint32(16).int32(message.indentType);
        }
        if (message.spread !== undefined) {
            common_1.Quotation.encode(message.spread, writer.uint32(26).fork()).join();
        }
    ...
    create(base) {
        return exports.PostStopOrderRequest_TrailingData.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b;
        const message = createBasePostStopOrderRequest_TrailingData();
        message.indent = (object.indent !== undefined && object.indent !== null)
            ...
            : undefined;
        message.indentType = (_a = object.indentType) !== null && _a !== void 0 ? _a : 0;
        message.spread = (object.spread !== undefined && object.spread !== null)
            ? common_1.Quotation.fromPartial(object.spread)
            : undefined;
        message.spreadType = (_b = object.spreadType) !== null && _b !== void 0 ? _b : 0;
        return message;
    },
};
...
exports.PostStopOrderResponse = {
    ...
    create(base) {
        return exports.PostStopOrderResponse.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b;
        const message = createBasePostStopOrderResponse();
        message.stopOrderId = (_a = object.stopOrderId) !== null && _a !== void 0 ? _a : "";
        message.orderRequestId = (_b = object.orderRequestId) !== null && _b !== void 0 ? _b : "";
...
exports.GetStopOrdersRequest = {
    ...
    create(base) {
        return exports.GetStopOrdersRequest.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b, _c, _d;
        const message = createBaseGetStopOrdersRequest();
...
exports.GetStopOrdersResponse = {
    ...
    fromJSON(object) {
        return {
            stopOrders: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.stopOrders)
    ...
    toJSON(message) {
        var _a;
        const obj = {};
        if ((_a = message.stopOrders) === null || _a === void 0 ? void 0 : _a.length) {
            obj.stopOrders = message.stopOrders.map((e) => exports.StopOrder.toJSON(e));
        }
        return obj;
    },
    create(base) {
        return exports.GetStopOrdersResponse.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a;
        const message = createBaseGetStopOrdersResponse();
...
exports.CancelStopOrderRequest = {
    ...
    create(base) {
        return exports.CancelStopOrderRequest.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b;
        const message = createBaseCancelStopOrderRequest();
...
exports.CancelStopOrderResponse = {
    ...
    create(base) {
        return exports.CancelStopOrderResponse.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a;
        const message = createBaseCancelStopOrderResponse();
...
exports.StopOrder = {
    encode(message, writer = new wire_1.BinaryWriter()) {
        ...
        if (message.trailingData !== undefined) {
            exports.StopOrder_TrailingData.encode(message.trailingData, writer.uint32(114).fork()).join();
        }
        if (message.status !== 0) {
    ...
    create(base) {
        return exports.StopOrder.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        ...
        message.takeProfitType = (_l = object.takeProfitType) !== null && _l !== void 0 ? _l : 0;
        message.trailingData = (object.trailingData !== undefined && object.trailingData !== null)
            ? exports.StopOrder_TrailingData.fromPartial(object.trailingData)
            : undefined;
        message.status = (_m = object.status) !== null && _m !== void 0 ? _m : 0;
        message.exchangeOrderType = (_o = object.exchangeOrderType) !== null && _o !== void 0 ? _o : 0;
        message.exchangeOrderId = (_p = object.exchangeOrderId) !== null && _p !== void 0 ? _p : undefined;
        return message;
    },
};
...
exports.StopOrder_TrailingData = {
    encode(message, writer = new wire_1.BinaryWriter()) {
        ...
        if (message.price !== undefined) {
            common_1.Quotation.encode(message.price, writer.uint32(58).fork()).join();
        }
        if (message.extr !== undefined) {
            common_1.Quotation.encode(message.extr, writer.uint32(66).fork()).join();
        }
        return writer;
    },
    decode(input, length) {
    ...
    create(base) {
        return exports.StopOrder_TrailingData.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b, _c;
        const message = createBaseStopOrder_TrailingData();
