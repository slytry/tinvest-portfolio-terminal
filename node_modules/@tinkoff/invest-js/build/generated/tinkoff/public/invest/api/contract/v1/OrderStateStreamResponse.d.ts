...
export declare const _tinkoff_public_invest_api_contract_v1_OrderStateStreamResponse_MarkerType: {
    readonly MARKER_UNKNOWN: "MARKER_UNKNOWN";
    readonly MARKER_BROKER: "MARKER_BROKER";
    readonly MARKER_CHAT: "MARKER_CHAT";
    readonly MARKER_PAPER: "MARKER_PAPER";
    readonly MARKER_MARGIN: "MARKER_MARGIN";
    readonly MARKER_TKBNM: "MARKER_TKBNM";
    readonly MARKER_SHORT: "MARKER_SHORT";
    readonly MARKER_SPECMM: "MARKER_SPECMM";
    readonly MARKER_PO: "MARKER_PO";
};
export type _tinkoff_public_invest_api_contract_v1_OrderStateStreamResponse_MarkerType = 'MARKER_UNKNOWN' | 0 | 'MARKER_BROKER' | 1 | 'MARKER_CHAT' | 2 | 'MARKER_PAPER' | 3 | 'MARKER_MARGIN' | 4 | 'MARKER_TKBNM' | 5 | 'MARKER_SHORT' | 6 | 'MARKER_SPECMM' | 7 | 'MARKER_PO' | 8;
...
export declare const _tinkoff_public_invest_api_contract_v1_OrderStateStreamResponse_StatusCauseInfo: {
    readonly CAUSE_UNSPECIFIED: "CAUSE_UNSPECIFIED";
    readonly CAUSE_CANCELLED_BY_CLIENT: "CAUSE_CANCELLED_BY_CLIENT";
    readonly CAUSE_CANCELLED_BY_EXCHANGE: "CAUSE_CANCELLED_BY_EXCHANGE";
    readonly CAUSE_CANCELLED_NOT_ENOUGH_POSITION: "CAUSE_CANCELLED_NOT_ENOUGH_POSITION";
    readonly CAUSE_CANCELLED_BY_CLIENT_BLOCK: "CAUSE_CANCELLED_BY_CLIENT_BLOCK";
    readonly CAUSE_REJECTED_BY_BROKER: "CAUSE_REJECTED_BY_BROKER";
    readonly CAUSE_REJECTED_BY_EXCHANGE: "CAUSE_REJECTED_BY_EXCHANGE";
    readonly CAUSE_CANCELLED_BY_BROKER: "CAUSE_CANCELLED_BY_BROKER";
};
