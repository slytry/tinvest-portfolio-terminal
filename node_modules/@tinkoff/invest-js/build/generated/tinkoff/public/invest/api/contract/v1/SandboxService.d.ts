...
export interface SandboxServiceClient extends grpc.Client {
    ...
    getSandboxAccounts(argument: _tinkoff_public_invest_api_contract_v1_GetAccountsRequest, options: grpc.CallOptions, callback: grpc.requestCallback<_tinkoff_public_invest_api_contract_v1_GetAccountsResponse__Output>): grpc.ClientUnaryCall;
    getSandboxAccounts(argument: _tinkoff_public_invest_api_contract_v1_GetAccountsRequest, callback: grpc.requestCallback<_tinkoff_public_invest_api_contract_v1_GetAccountsResponse__Output>): grpc.ClientUnaryCall;
    GetSandboxMaxLots(argument: _tinkoff_public_invest_api_contract_v1_GetMaxLotsRequest, metadata: grpc.Metadata, options: grpc.CallOptions, callback: grpc.requestCallback<_tinkoff_public_invest_api_contract_v1_GetMaxLotsResponse__Output>): grpc.ClientUnaryCall;
    GetSandboxMaxLots(argument: _tinkoff_public_invest_api_contract_v1_GetMaxLotsRequest, metadata: grpc.Metadata, callback: grpc.requestCallback<_tinkoff_public_invest_api_contract_v1_GetMaxLotsResponse__Output>): grpc.ClientUnaryCall;
    GetSandboxMaxLots(argument: _tinkoff_public_invest_api_contract_v1_GetMaxLotsRequest, options: grpc.CallOptions, callback: grpc.requestCallback<_tinkoff_public_invest_api_contract_v1_GetMaxLotsResponse__Output>): grpc.ClientUnaryCall;
    GetSandboxMaxLots(argument: _tinkoff_public_invest_api_contract_v1_GetMaxLotsRequest, callback: grpc.requestCallback<_tinkoff_public_invest_api_contract_v1_GetMaxLotsResponse__Output>): grpc.ClientUnaryCall;
    getSandboxMaxLots(argument: _tinkoff_public_invest_api_contract_v1_GetMaxLotsRequest, metadata: grpc.Metadata, options: grpc.CallOptions, callback: grpc.requestCallback<_tinkoff_public_invest_api_contract_v1_GetMaxLotsResponse__Output>): grpc.ClientUnaryCall;
    getSandboxMaxLots(argument: _tinkoff_public_invest_api_contract_v1_GetMaxLotsRequest, metadata: grpc.Metadata, callback: grpc.requestCallback<_tinkoff_public_invest_api_contract_v1_GetMaxLotsResponse__Output>): grpc.ClientUnaryCall;
    getSandboxMaxLots(argument: _tinkoff_public_invest_api_contract_v1_GetMaxLotsRequest, options: grpc.CallOptions, callback: grpc.requestCallback<_tinkoff_public_invest_api_contract_v1_GetMaxLotsResponse__Output>): grpc.ClientUnaryCall;
    getSandboxMaxLots(argument: _tinkoff_public_invest_api_contract_v1_GetMaxLotsRequest, callback: grpc.requestCallback<_tinkoff_public_invest_api_contract_v1_GetMaxLotsResponse__Output>): grpc.ClientUnaryCall;
...
export interface SandboxServiceHandlers extends grpc.UntypedServiceImplementation {
    ...
    GetSandboxMaxLots: grpc.handleUnaryCall<_tinkoff_public_invest_api_contract_v1_GetMaxLotsRequest__Output, _tinkoff_public_invest_api_contract_v1_GetMaxLotsResponse>;
...
export interface SandboxServiceDefinition extends grpc.ServiceDefinition {
    ...
    GetSandboxMaxLots: MethodDefinition<_tinkoff_public_invest_api_contract_v1_GetMaxLotsRequest, _tinkoff_public_invest_api_contract_v1_GetMaxLotsResponse, _tinkoff_public_invest_api_contract_v1_GetMaxLotsRequest__Output, _tinkoff_public_invest_api_contract_v1_GetMaxLotsResponse__Output>;
