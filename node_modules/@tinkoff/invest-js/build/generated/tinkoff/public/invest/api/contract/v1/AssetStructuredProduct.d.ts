...
import type { StructuredProductType as _tinkoff_public_invest_api_contract_v1_StructuredProductType, StructuredProductType__Output as _tinkoff_public_invest_api_contract_v1_StructuredProductType__Output } from '../../../../../../tinkoff/public/invest/api/contract/v1/StructuredProductType';
...
export interface AssetStructuredProduct {
    ...
    'type'?: (_tinkoff_public_invest_api_contract_v1_StructuredProductType);
    'logicPortfolio'?: (string);
    'assetType'?: (_tinkoff_public_invest_api_contract_v1_AssetType);
    'basicAsset'?: (string);
...
export interface AssetStructuredProduct__Output {
    ...
    'nominalCurrency': (string);
    'type': (_tinkoff_public_invest_api_contract_v1_StructuredProductType__Output);
    'logicPortfolio': (string);
    'assetType': (_tinkoff_public_invest_api_contract_v1_AssetType__Output);
    'basicAsset': (string);
