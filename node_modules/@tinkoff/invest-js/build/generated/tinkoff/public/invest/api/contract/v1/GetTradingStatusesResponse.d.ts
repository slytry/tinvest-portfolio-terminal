...
export interface GetTradingStatusesResponse {
    'tradingStatuses'?: (_tinkoff_public_invest_api_contract_v1_GetTradingStatusResponse)[];
}
export interface GetTradingStatusesResponse__Output {
    'tradingStatuses': (_tinkoff_public_invest_api_contract_v1_GetTradingStatusResponse__Output)[];
}
