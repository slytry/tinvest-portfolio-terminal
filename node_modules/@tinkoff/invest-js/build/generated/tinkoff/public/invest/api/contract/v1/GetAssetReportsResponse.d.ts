...
export declare const _tinkoff_public_invest_api_contract_v1_GetAssetReportsResponse_AssetReportPeriodType: {
    readonly PERIOD_TYPE_UNSPECIFIED: "PERIOD_TYPE_UNSPECIFIED";
    readonly PERIOD_TYPE_QUARTER: "PERIOD_TYPE_QUARTER";
    readonly PERIOD_TYPE_SEMIANNUAL: "PERIOD_TYPE_SEMIANNUAL";
    readonly PERIOD_TYPE_ANNUAL: "PERIOD_TYPE_ANNUAL";
};
export type _tinkoff_public_invest_api_contract_v1_GetAssetReportsResponse_AssetReportPeriodType = 'PERIOD_TYPE_UNSPECIFIED' | 0 | 'PERIOD_TYPE_QUARTER' | 1 | 'PERIOD_TYPE_SEMIANNUAL' | 2 | 'PERIOD_TYPE_ANNUAL' | 3;
