...
export declare const _tinkoff_public_invest_api_contract_v1_GetCandlesRequest_CandleSource: {
    readonly CANDLE_SOURCE_UNSPECIFIED: "CANDLE_SOURCE_UNSPECIFIED";
    readonly CANDLE_SOURCE_EXCHANGE: "CANDLE_SOURCE_EXCHANGE";
    readonly CANDLE_SOURCE_INCLUDE_WEEKEND: "CANDLE_SOURCE_INCLUDE_WEEKEND";
};
export type _tinkoff_public_invest_api_contract_v1_GetCandlesRequest_CandleSource = 'CANDLE_SOURCE_UNSPECIFIED' | 0 | 'CANDLE_SOURCE_EXCHANGE' | 1 | 'CANDLE_SOURCE_INCLUDE_WEEKEND' | 3;
